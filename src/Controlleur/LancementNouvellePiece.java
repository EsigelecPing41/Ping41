...
public class LancementNouvellePiece extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			a = new Assemblage(request.getParameter("numero_serie"), request.getParameter("nb_dossier_def"), request.getParameter("code_gpao"), request.getParameter("ind_nomencl"), request.getParameter("designation_de_la_piece"),request.getParameter("ordre_fabrication"), request.getParameter("numero_affaire"));
