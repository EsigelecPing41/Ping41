...
/**
 * Classe d'acc�s aux donn�es contenues dans la table ActionPiece
 * */
		...
		public static ActionAssemblageDAO getInstance() throws Exception
		{
			...
			return singleton;
				...
				*/
				 ...
				 * @param l'id de l'action � supprimer
				 *@return null si aucune Action ne correspond � cet id
				 */
				...
				/**
				 * Permet de r�cup�rer une action assemblage � partir de son id 
				 * @param id de l'action � r�cup�rer
				 * @return l'action
				 * @return null si aucune action ne correspond � cet
				 */
				...
				/**
				 * Permet de r�cup�rer toutes les Actions de la table pour un assemblage donne
