...
public class Commande 
{
    ...
    private int Com_F_ID;
    private int Com_BCom_ID;
    private int Com_P_ID;
    private int Com_ID;


    public Commande( Date Com_Date, int Com_F_ID ,int Com_BCom_ID,int Com_P_ID, int Com_ID)
    {
    	this.Com_Date=Com_Date;
    	this.Com_F_ID=Com_F_ID;
    ...
    public int getCom_F_ID()
    {
        return this.Com_F_ID;
    }   
    public void setCom_F_ID(final int value)
    {
        this.Com_F_ID = value;
    }
