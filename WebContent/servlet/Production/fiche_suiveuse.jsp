...
<center><h1>Production</h1>
	...
	<table  class="tableau">
		...
		<tr>
			...
			<td class="case"></td>
			<td class="case">N°Série <input type="text" size="2" style="width:10px"><input type="text" size="2" style="width:10px"><input type="text" size="2" style="width:10px"><input type="text" size="2" style="width:10px"><input type="text" size="2" style="width:10px"><input type="text" size="2" style="width:10px"> <input type="text" size="2" style="width:10px"><input type="text" size="2" style="width:10px"></td>
